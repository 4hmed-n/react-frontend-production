          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-3">
              <a
                ...
                className="p-2 rounded-full border border-white/10 text-gray-300 hover:text-white hover:border-sky-400/50 transition-colors"
                aria-label="Gmail"
              >
            ...
            <Link to="/" className="flex items-center gap-2 text-sm md:text-lg font-bold tracking-tighter uppercase font-display hover:text-sky-400 transition-colors duration-300">
