              ...
              <div className="md:hidden relative">
                ...
                {isMobileSocialOpen && (
                  <div className="absolute mt-3 left-0 z-50 rounded-2xl border border-white/10 bg-slate-900/90 backdrop-blur-xl p-2 space-y-2">
                    <a href="mailto:ahmednuman3044@gmail.com" className="flex items-center gap-2 text-xs text-gray-200 px-3 py-2 rounded-full hover:bg-white/10">📧 Gmail</a>
                    <a href="https://github.com/4hmed-n" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-gray-200 px-3 py-2 rounded-full hover:bg-white/10">🐙 GitHub</a>
                    <a href="https://www.docker.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-xs text-gray-200 px-3 py-2 rounded-full hover:bg-white/10">🐳 Docker</a>
                    <a href="#" className="flex items-center gap-2 text-xs text-gray-200 px-3 py-2 rounded-full hover:bg-white/10">in LinkedIn</a>
                  </div>
                )}
              </div>
